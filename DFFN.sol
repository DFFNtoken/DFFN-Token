...
contract DolphinFinanceforNature is Context, IERC20, Ownable {
    ...
    string private _name = "DOLPHIN FINANCE FOR NATURE";
    string private _symbol = "DFFN";
